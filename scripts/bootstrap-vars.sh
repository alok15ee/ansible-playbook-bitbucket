...
perl -i -p -e "s/^#(apache2_vhosts_ssl_certificate_key_file):.*/#\1: '\/etc\/ssl\/private\/ssl-cert-snakeoil.key'/g" $TMP_VARS
perl -i -p -e "s/^#(apache2_vhosts_ssl_engine):.*/#\1: 'On'/g" $TMP_VARS
